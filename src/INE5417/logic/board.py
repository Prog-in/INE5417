...
class Board:
    ...
    def update_move_info(self, selected_triangle: Triangle):
        self.last_move_info = (self.get_selected_stone(), selected_triangle)
        self.selected_stone_info = None

    def set_selected_stone(self, selected_stone: Stone, in_left: bool) -> None:
        self.selected_stone_info = (selected_stone, in_left)

    def stone_selected(self, stone_value: int, in_left: bool) -> None:
        selected_stone = self.local_player.get_stone(stone_value, in_left)
        self.set_selected_stone(selected_stone, in_left)
